...
@section('content')
    <section class="content">
        ...
        <form id="registration-form" method="POST" action="{{ url('admin/update-company/'.$company['id']) }}">
            @csrf
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="form-group">
                                            <input type="email" readonly id="email" value="{{$company['email']}}" name="email" class="form-control"
                                    ...
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-primary btn-round"> Update Company</button>
                                    </div>
                                </div>
                            </div>
                        </div>
